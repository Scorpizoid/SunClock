...
void CSunClockAppUi::HandleCommandL(TInt aCommand)
	...
	_LIT(KAboutDialogTitle,"SunClock v1.02"); 

			// ja teksti
	_LIT(KAboutDialogText,"A Series 80 freeware app\nby Sami Vuori.\nhttp://www.symbioosi.net\n\nMap images by NASA."); 
	...
	switch (aCommand)
		{
      // Kolmella ylimm‰ll‰ CBA-napilla ei ole mit‰‰n funktiota (viel‰)
	case ECbaButton0:
		break;
	...
	case ESunClockAbout:
		...
		CCknInfoDialog::RunDlgLD(KAboutDialogTitle,KAboutDialogText);
		break;
